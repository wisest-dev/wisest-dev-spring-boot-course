...
@SpringBootTest
@ActiveProfiles("tests2")
public class CompletionCertificateServiceWithOtherBrandTest {
    ...
    public void brandNameIsReturned() {
        assertThat(completionCertificateService.getBrandName()).isEqualTo("Other Brand Tests2");
    }
