...
@SpringBootApplication(scanBasePackages = {"dev.wisest.multimodule.application", "dev.wisest.shared.library"})
public class ApplicationUsingSharedComponent {

    public static void main(String[] args) {
        SpringApplication.run(ApplicationUsingSharedComponent.class, args);
    }
